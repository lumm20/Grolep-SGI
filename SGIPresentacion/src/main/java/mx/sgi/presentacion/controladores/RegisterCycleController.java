...
public class RegisterCycleController implements Initializable {
...
//        }
    ...
    private String generateCycleId(){
        String startYear = String.valueOf(dpStart.getValue().getYear());
        String endYear = String.valueOf(dpEnd.getValue().getYear());
    ...
    private void registerCycle(){
        try {
            ...
            DetalleCicloDTO details = DetalleCicloDTO.builder()
                    .idCicloEscolar(generateCycleId())
